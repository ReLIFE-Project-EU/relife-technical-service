...
async def fv_endpoint(
    ...
    try:
        fv_kpi_weight, ii_normalized, aoc_normalized, irr_normalized, npv_normalized = (
            calculate_fv(
        ...
        return FVResponse(
            fv_kpi_weight=fv_kpi_weight,
            ii_normalized=ii_normalized,
            aoc_normalized=aoc_normalized,
            irr_normalized=irr_normalized,
            npv_normalized=npv_normalized,
            input=request,
        )
